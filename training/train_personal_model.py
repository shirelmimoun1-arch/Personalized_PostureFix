...
FORCE_TRAIN_SEGMENTS = {

}
FORCE_TRAIN_SEGMENTS_BY_LABEL = {
    "Good": {
        "good_pose_1",  # natural good posture
        "good_pose_4",  # head turn right
        "good_pose_7",  # head tilt left
        "good_pose_9",  # lean right
        "good_pose_12",  # rotate left
        "good_pose_13"  # lean hand right
    },
    "Bad": {
        "bad_pose_1",   # head down
        "bad_pose_2",   # head tilt left
        "bad_pose_5",   # head close to the screen
        "bad_pose_6",  # lean with hand left
        "bad_pose_9",   # lean right
        "bad_pose_10",  # tilt head left
        "bad_pose_11",    # right shoulder down
        "bad_pose_16",  #sholders up
        "bad_pose_19"  # rotate right
    }
}
